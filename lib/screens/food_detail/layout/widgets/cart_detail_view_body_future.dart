...
class CartDetailBodyFuture extends StatefulWidget {
  final url;
  final docId;
  final productName;
  ...
  @override
  State<CartDetailBodyFuture> createState() => _CartDetailBodyFutureState();
}
...
class _CartDetailBodyFutureState extends State<CartDetailBodyFuture> {
  @override
  void dispose() {
    super.dispose();
  ...
  Widget build(BuildContext context) {
    double productPrice = double.parse(widget.totalPrice);
    index = int.parse(widget.totalCount);
                      ...
                      if (index > 1) {
                        double tempProductPrice =
                            double.parse(widget.totalPrice) /
                                double.parse(widget.totalCount);

                        index--;
                        tempProductPrice = productPrice - tempProductPrice;
                        productPrice = tempProductPrice;
                        tempProductPrice = double.parse(widget.totalPrice) /
                            double.parse(widget.totalCount);
