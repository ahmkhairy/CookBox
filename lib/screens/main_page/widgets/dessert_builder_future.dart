...
class DessertBuilderFuture extends StatefulWidget {
  const DessertBuilderFuture({super.key});

  @override
  State<DessertBuilderFuture> createState() => _DessertBuilderFutureState();
}

ViewProductViewModel viewModel = ViewProductViewModel();

class _DessertBuilderFutureState extends State<DessertBuilderFuture> {
  @override
            ...
            child: Column(
              children: <Widget>[
                FutureBuilder<List<dynamic>?>(
                    future: viewModel.getDessertProducts(),
